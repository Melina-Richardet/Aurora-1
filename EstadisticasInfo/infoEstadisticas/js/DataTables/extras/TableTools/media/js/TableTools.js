...
TableTools.prototype = {
	...
	"fnGetSelectedData": function ()
	{
		...
		{
			alert("fnGetSelectedData");
			alert(this.s.dt.oInstance.fnGetData( selected[i] ));
				...
				for ( i=0, iLen=dt.aoColumns.length ; i<iLen ; i++ )
				{
					if ( aColumnsInc[i] )
					{
						...
						else if ( typeof mTypeData == "string" )
						{
							...
							//alert(sLoopData);
							//alert(sLoopData);
							sLoopData = filtrarHTML_tableTools(sLoopData);
	...
	"_fnPrintStart": function ( e, oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		var cabecera_pagina = document.getElementById("cabeceraTabla");
		if(cabecera_pagina!=null)cabecera_pagina.style.display = 'block';
		
		var container_contactos = document.getElementById("container_contactos");
		if(container_contactos!=null)container_contactos.style.cssFloat = 'none';
		
		var container_calificacion = document.getElementById("container_calificacion");
		if(container_calificacion!=null){
			container_calificacion.style.cssFloat = 'left';
			container_calificacion.style.width="825px"
				container_calificacion.style.position="none";
		}
		
		var container_calificacion_grupal = document.getElementById("container_calificacion_grupal");
		if(container_calificacion_grupal!=null){
			container_calificacion_grupal.style.cssFloat = 'left';
			container_calificacion_grupal.style.width="825px"
				container_calificacion_grupal.style.position="none";
		}
		
		var container_calificacion_individual = document.getElementById("container_calificacion_individual");
		if(container_calificacion_individual!=null){
			container_calificacion_individual.style.cssFloat = 'left';
			container_calificacion_individual.style.width="825px"
				container_calificacion_individual.style.position="none";
		}
		
		
		var tablaexample2cargarNotas = document.getElementById("example2cargarNotas");
		if(tablaexample2cargarNotas!=null){
			var oTable = $('#example2cargarNotas').dataTable();
			if(oTable != null){
		...
		var tablacalificacionesComision = document.getElementById("calificacionesComision");
		if(tablacalificacionesComision!=null){
			var oTable1 = $('#calificacionesComision').dataTable();
			if(oTable1 != null){
				// Hide the second column after initialisation
		...
		var tablaexampleIndividual = document.getElementById("exampleIndividual");
		if(tablaexampleIndividual!=null){
			var oTable2 = $('#exampleIndividual').dataTable();
			if(oTable2 != null){
				// Hide the second column after initialisation
				oTable2.fnSetColumnVis( 0, true );
			}
		}
		...
		if ( oConfig.sInfo !== "" )
		{
			//alert("Vista previa. Utilizar el imprimir del navegador.");
	...
	"_fnPrintEnd": function ( e )
	{
		...
		if ( e.keyCode == 27 )
		{
			...
			var cabecera_pagina = document.getElementById("cabeceraTabla");
			if(cabecera_pagina!=null)cabecera_pagina.style.display = 'none';
			
			var container_contactos = document.getElementById("container_contactos");
			if(container_contactos!=null)container_contactos.style.cssFloat = 'right';
			
			var container_calificacion = document.getElementById("container_calificacion");
			if(container_calificacion!=null){
				container_calificacion.style.cssFloat = 'right';
				container_calificacion.style.width="750px"
					container_calificacion.style.position="absolute";
			}
			...
			var tablacalificacionesIndividuales = document.getElementById("calificacionesIndividuales");
			if(tablacalificacionesIndividuales!=null){
				var oTable3 = $('#calificacionesIndividuales').dataTable();
				if(oTable3 != null){
					// Hide the second column after initialisation
			...
			var tablaactGrupales = document.getElementById("actGrupales");
			if(tablaactGrupales!=null){
				var oTable4 = $('#actGrupales').dataTable();
				if(oTable4 != null){
					// Hide the second column after initialisation
	...
	//@jconde
	  //quitarEstiloContenidoTableTools();
	...
	"_fnPrintHideNodes": function ( nNode )
	{
	  ...
	  //@jconde
	  //agregarEstiloContenidoTableTools();
...
TableTools.BUTTONS = {
	"csv": {
		...
		"sNewLine": "auto",
		"sTitle": "",
		"sToolTip": "Generar archivo para planilla de calculo (datos seperados por coma)",
	...
	"xls": {
		...
		"sNewLine": "auto",
		"sTitle": "",
		"sToolTip": "Generar archivo para planilla de calculo",
		"sButtonClass": "DTTT_button_xls",
		"sButtonClassHover": "DTTT_button_xls_hover",
		"sButtonText": "Planilla de c&aacute;lculo",//Excel - Calc
		"mColumns": "all",
		"bHeader": true,
		"bFooter": true,
		"bSelectedOnly": false,
	...
	"copy": {
		...
		"sFieldSeperator": "\t",
		"sNewLine": "auto",
		"sToolTip": "Copiar registros al portapapel para luego pegar",
	...
	"print": {
		"sAction": "print",
		"sInfo": "<h6>Vista previa</h6><p>Por favor, use la funcion de impresi&oacute;n de su navegador para imprimir esta tabla. Pulse Escape cuando haya terminado.</p>",
		"sMessage": "",
		"bShowAll": true,
		"sToolTip": "Vista previa imprimir",
